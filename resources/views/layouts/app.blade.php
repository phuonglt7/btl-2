...
<head>
    ...
    <script src="{{ asset('js/checkDelete.js') }}" defer></script>
    <script src="{{ asset('js/checkFrom.js') }}" defer></script>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('transfer.create') }}">
                    CHUYỂN TIỀN
                </a>
                 <a class="navbar-brand" href="{{ route('collect.index') }}">
                    QUẢN LÝ THU
                </a>
                <a class="navbar-brand" href="{{ route('pay.index') }}">
                    QUẢN LÝ CHI
                </a>
